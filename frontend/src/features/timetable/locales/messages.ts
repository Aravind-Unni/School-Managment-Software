...
export const TIMETABLE_MESSAGES: Record<Language, Record<string, string>> = {
  en: {
    ...
    "timetable.substitution.step_period": "1. Which period needs cover?",
    "timetable.substitution.step_teacher": "2. Who covers",
    "timetable.substitution.no_school": "No school on this day.",
    "timetable.substitution.no_periods": "This class has no periods on this day.",
    "timetable.substitution.covered_by": "Covered by",
    "timetable.substitution.cancelled": "Cancelled",
    "timetable.substitution.busy": "Teaching another class then",
    "timetable.substitution.free": "Free",
    "timetable.substitution.periods_today": "periods today",
    "timetable.substitution.reason.leave": "On leave",
    "timetable.substitution.reason.sick": "Unwell",
    "timetable.substitution.reason.training": "Training",
    "timetable.substitution.reason.duty": "Official duty",
    "timetable.substitution.reason.other": "Other",
    "timetable.substitution.reason_other": "Say why",
    "timetable.substitution.note": "Note (optional)",
    "timetable.substitution.assign_to": "Assign",
    "timetable.substitution.covers": "covers",
    "timetable.substitution.today": "Cover arranged for this day",
    "timetable.substitution.instead_of": "for",
  ...
  ml: {
    ...
    "timetable.substitution.step_period": "1. ഏത് പീരിയഡിന് പകരം വേണം?",
    "timetable.substitution.step_teacher": "2. ആര് എടുക്കും",
    "timetable.substitution.no_school": "ഈ ദിവസം സ്കൂളില്ല.",
    "timetable.substitution.no_periods": "ഈ ദിവസം ഈ ക്ലാസിന് പീരിയഡുകളില്ല.",
    "timetable.substitution.covered_by": "പകരം",
    "timetable.substitution.cancelled": "റദ്ദാക്കി",
    "timetable.substitution.busy": "ആ സമയം മറ്റൊരു ക്ലാസിൽ",
    "timetable.substitution.free": "ഒഴിവ്",
    "timetable.substitution.periods_today": "പീരിയഡുകൾ ഇന്ന്",
    "timetable.substitution.reason.leave": "അവധി",
    "timetable.substitution.reason.sick": "അസുഖം",
    "timetable.substitution.reason.training": "പരിശീലനം",
    "timetable.substitution.reason.duty": "ഔദ്യോഗിക ചുമതല",
    "timetable.substitution.reason.other": "മറ്റുള്ളവ",
    "timetable.substitution.reason_other": "കാരണം എഴുതുക",
    "timetable.substitution.note": "കുറിപ്പ് (ഐച്ഛികം)",
    "timetable.substitution.assign_to": "നിയോഗിക്കുക:",
    "timetable.substitution.covers": "എടുക്കും",
    "timetable.substitution.today": "ഈ ദിവസത്തെ പകരം ക്രമീകരണം",
    "timetable.substitution.instead_of": "പകരം",
