# backend/modules/communications -- M11
...
`import modules.communications` does technically succeed and yields an empty module. What
does **not** exist -- and what the guarantee actually rests on -- is
`modules.communications.registration`. Importing it raises `ModuleNotFoundError`, which is
why `scripts/dev.py up M11` reports "not implemented" instead of booting an empty
...
Read [`contracts/M11/PACKET.md`](../../../contracts/M11/PACKET.md) first. The
