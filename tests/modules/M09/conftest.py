"""Fixtures for M09's suite. MODULE_ID=M09; fake Access/Registry/Platform."""
...
def _persona(settings):
    """Default persona is librarian/principal with recent 2FA."""
...
def baseline(db, clock):
    """Seed one available copy."""
    from modules.library.seeds import seed_baseline
