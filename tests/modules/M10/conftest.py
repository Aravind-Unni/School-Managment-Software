"""Fixtures for M10's suite. MODULE_ID=M10; fake Access/Registry/Platform."""
...
def _persona(settings):
    """Default persona is alumni reviewer with recent 2FA."""
...
def baseline(db, clock):
    """Seed policy and two pending candidates."""
    from modules.alumni.seeds import seed_baseline
